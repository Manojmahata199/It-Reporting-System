                       ...
                       <div class="d-flex col-md-6">
                        ...
                        <div class="d-flex col-md-6">
                          ...
                          <div class="col-md-8">
                            ...
                            <input type="text" class="form-control" id="call_time" name="call_time" aria-describedby="emailHelp" value="<?php echo $row['call_time']; ?>" required>
                   ...
                   <div class="d-flex col-md-12 my-2">
                    <div class="d-flex col-md-6">
                         ...
                         <div class="d-flex col-md-6">
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" id="call_close_time" name="call_close_time" value="<?php echo $row['call_close_time']; ?>" required>
